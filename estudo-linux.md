...
- [🔐 Capítulo 18 – Permissões Especiais e Links](https://github.com/jonasferreira-silva1/Fundamentos-do-Linux/blob/main/estudo-linux.md#-cap%C3%ADtulo-18--permiss%C3%B5es-especiais-e-links)
...
> ✅ **O que aprendemos de forma simples:**

- Permissões de arquivos e diretórios seguem **regras precisas**, e variam para dono, grupo e outros.
- O acesso depende de **`r`, `w`, `x`**, e saber **como cada uma afeta ações como ler, listar, deletar ou executar**.
